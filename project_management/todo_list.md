...
* 11/23 to do lis
  * Create page for adding notes to to do list
  * create script to automate update of to do list
  * create script to automate update of all the dashboard content
  * create an archive menu tab on the left so I can always go back and review the most recent draft
  * Create page/s that allow me to enter my writing and then submit my writing to AI and ask AI to integrate into my broader project
